      ...
      <div className="bg-lightWhite">
        <div className=" container mx-auto max-w-[1366px]">
          <div className="h-fit  flex items-center justify-center ">
            <div className="shadow-lg w-5/6 mt-16 md:mt-24 p-8 h-fit relative rounded-md bg-white">
                ...
                <div className="w-[490px] relative">
                  <Carousel
                    ...
                    indicatorContainerProps={{
                      style: {
                        position: "absolute",
                        bottom: "30px", // adjust this value according to your layout
                        // top: "10px",
                        width: "100%",
                        display: "flex",
          ...
          <div className="h-fit mt-10 pb-10 flex items-center justify-center">
            <div className="shadow-lg w-5/6  p-8 h-fit relative rounded-md bg-blue-300 bg-white">
